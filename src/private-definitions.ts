...
type WrappedMethods =
  | keyof PickByType<CapacitorThermalPrinterPlugin, (...args: any[]) => CapacitorThermalPrinterPlugin>
  | 'write';
...
export type WrappedMethodsMiddlewareMap<T extends WrappedMethodsArgsMap> = {
  [P in WrappedMethods]?: (
    ...args: Parameters<CapacitorThermalPrinterPlugin[P]>
  ) => Promisable<Record<T[P][number], unknown>>;
};
